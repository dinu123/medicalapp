...
const productTemplates = [
  { baseName: 'Paracetamol 500mg', hsn: '30049099', pack: '10 tabs', mfr: 'Pharma Inc.', tax: 12, salts: 'Paracetamol', schedule: 'none' as MedicineSchedule },
  { baseName: 'Amoxicillin 250mg', hsn: '30041090', pack: '10 caps', mfr: 'MediHealth', tax: 12, salts: 'Amoxicillin', schedule: 'H' as MedicineSchedule },
  { baseName: 'Ibuprofen 200mg', hsn: '30049011', pack: '15 tabs', mfr: 'Pharma Inc.', tax: 12, salts: 'Ibuprofen', schedule: 'none' as MedicineSchedule },
  { baseName: 'Cetirizine 10mg', hsn: '30049029', pack: '10 tabs', mfr: 'AllergyCure', tax: 5, salts: 'Cetirizine', schedule: 'none' as MedicineSchedule },
  { baseName: 'Vitamin C 1000mg', hsn: '21069099', pack: '20 tabs', mfr: 'HealthBoost', tax: 18, salts: 'Ascorbic Acid', schedule: 'none' as MedicineSchedule },
  { baseName: 'Aspirin 75mg', hsn: '30049091', pack: '14 tabs', mfr: 'HeartCare', tax: 5, salts: 'Acetylsalicylic Acid', schedule: 'none' as MedicineSchedule },
  { baseName: 'Omeprazole 20mg', hsn: '30049023', pack: '10 caps', mfr: 'GastroWell', tax: 12, salts: 'Omeprazole', schedule: 'H' as MedicineSchedule },
  { baseName: 'Losartan 50mg', hsn: '30049079', pack: '15 tabs', mfr: 'BP-Control', tax: 12, salts: 'Losartan Potassium', schedule: 'H' as MedicineSchedule },
  { baseName: 'Metformin 500mg', hsn: '30049049', pack: '30 tabs', mfr: 'DiaCure', tax: 12, salts: 'Metformin Hydrochloride', schedule: 'H' as MedicineSchedule },
  { baseName: 'Atorvastatin 10mg', hsn: '30049035', pack: '10 tabs', mfr: 'LipiGo', tax: 12, salts: 'Atorvastatin Calcium', schedule: 'H1' as MedicineSchedule },
  { baseName: 'Salbutamol Inhaler', hsn: '30049012', pack: '200 dose', mfr: 'BreatheEasy', tax: 18, salts: 'Salbutamol Sulphate', schedule: 'H' as MedicineSchedule },
  { baseName: 'Diclofenac Gel 30g', hsn: '30049099', pack: '30g tube', mfr: 'PainOff', tax: 18, salts: 'Diclofenac Diethylamine', schedule: 'none' as MedicineSchedule },
  { baseName: 'Multivitamin Syrup', hsn: '21069099', pack: '200ml', mfr: 'NutriLife', tax: 18, salts: 'Multiple Vitamins', schedule: 'none' as MedicineSchedule },
  { baseName: 'Cough Syrup DX', hsn: '30049039', pack: '100ml', mfr: 'CoughCure', tax: 12, salts: 'Dextromethorphan, Phenylephrine', schedule: 'none' as MedicineSchedule },
  { baseName: 'Pain Relief Spray', hsn: '30049099', pack: '55g', mfr: 'MoveFree', tax: 18, salts: 'Diclofenac, Methyl Salicylate', schedule: 'none' as MedicineSchedule },
  { baseName: 'Digital Thermometer', hsn: '90251190', pack: '1 pc', mfr: 'MediCare Devices', tax: 12, salts: 'N/A', schedule: 'none' as MedicineSchedule },
  { baseName: 'Antacid Liquid 170ml', hsn: '30049021', pack: '170ml', mfr: 'GastroWell', tax: 12, salts: 'Magnesium Hydroxide, Simethicone', schedule: 'none' as MedicineSchedule },
  { baseName: 'Band-Aid Assorted', hsn: '30051090', pack: '100 pcs', mfr: 'FirstAid Co.', tax: 5, salts: 'N/A', schedule: 'none' as MedicineSchedule },
];
